...
declare namespace H.map {
  ...
  class ViewModel extends H.util.EventTarget implements H.map.IControl {
     ...
     * @param opt_integerZoom Indicates if the resulting zoom level should be rounded down. It is only applied in case that the LookAtData's zoom level is not specified but bounds are. This can be used to prevent blurry raster tile maps when set the "look at" to specified bounds. Default is `false`.
     */
    setLookAtData (data : H.map.ViewModel.ILookAtData , opt_animate ? : boolean | number , opt_integerZoom ? : boolean ) : H.map.ViewModel ;
    /**
     * To start the controlling of the look-at-point animation. After this method was invoked, the look-at-point
...
declare namespace H.service {
  /**
   * This class encapsulates the [HERE Geofencing API v8](https://www.here.com/docs/category/geofencing-api)
   * as a service stub.
   *
   * It is not allowed to call the constructor directly (an `IllegalOperationError` is thrown).
   * Instead an instance of this Service can be retrieved by calling the factory method
   * {@link H.service.Platform#getGeofencingService} on a platform instance.
   */
  class GeofencingService extends H.service.Service {
    /**
     * This class encapsulates the [HERE Geofencing API v8](https://www.here.com/docs/category/geofencing-api)
     * as a service stub.
     *
    ...
    /**
     * This method sends a geofence delete request to
     * [HERE Geofencing API v8](https://www.here.com/docs/category/geofencing-api) and
     * calls the `onResult` callback function once the service response
     * becomes available (providing a {@link H.service.ServiceResult} object)
     * or the `onError` callback if a communication error occurred.
     *
     * Please refer to the
     * [HERE Geofencing API v8](https://www.here.com/docs/category/geofencing-api) documentation
     * for information on available parameters and the response object structure.
     ...
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    delete (params : H.service.ServiceParameters , onResult : (a : GlobalObject ) => any , onError : (a : Error ) => any ) : H.util.ICancelable ;
    /**
     * This method sends a geofence request to the
     * [HERE Geofencing API v8](https://www.here.com/docs/category/geofencing-api) and
     * calls the `onResult` callback function once the service response
     * becomes available (providing a {@link H.service.ServiceResult} object)
     * or the `onError` callback if a communication error occurred.
     ...
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    geofence (params : H.service.ServiceParameters , onResult : (a : GlobalObject ) => any , onError : (a : Error ) => any ) : H.util.ICancelable ;
    /**
     * This method sends a modify request to
     * [HERE Geofencing API v8](https://www.here.com/docs/category/geofencing-api) and
     * calls the `onResult` callback function once the service response
     * becomes available (providing a {@link H.service.ServiceResult} object)
     * or the `onError` callback if a communication error occurred.
     ...
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    modify (params : H.service.ServiceParameters , data : Blob , onResult : (a : GlobalObject ) => any , onError : (a : Error ) => any ) : H.util.ICancelable ;
    /**
     * This method sends a upload request to
     * [HERE Geofencing API v8](https://www.here.com/docs/category/geofencing-api) and
     * calls the `onResult` callback function once the service response
     * becomes available (providing a {@link H.service.ServiceResult} object)
     * or the `onError` callback if a communication error occurred.
     ...
     * [HERE Geofencing API v8](https://www.here.com/docs/category/geofencing-api) documentation
     * for information on available parameters and the response object structure.
     * @param params Contains service parameter to be sent with the request.
     * @param data The payload to send.
     * @param onResult A callback function to be called once the API provides a response to the request.
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    upload (params : H.service.ServiceParameters , data : Blob , onResult : (a : GlobalObject ) => any , onError : (a : Error ) => any ) : H.util.ICancelable ;
    /**
     * The property name to use when specifying options for this service
     * within the {@link H.service.Platform.Options#servicesConfig}.
     */
...
declare namespace H.service {
  ...
  class Platform {
    ...
    /**
     * To create a new instance of either {@link H.service.extension.geofencing.Service}
     * or {@link H.service.GeofencingService} to query the selected Geofencing API.
     * For compatibility reasons the class defaults to the deprecated
     * [HERE Fleet Telematics API](https://www.here.com/docs/category/fleet-telematics-api),
     * new applications should provide the optional `opt_version` parameter to get access to the new
     * [HERE Geofencing API v8](https://www.here.com/docs/category/geofencing-api)
     * @param opt_options Configuration options for Geofencing service
     * @param opt_version Indicates the optional version of the Geofencing API to use, allowed values are `8` for the [HERE Geofencing API v8](https://www.here.com/docs/category/geofencing-api) or `undefined` for the deprecated [HERE Fleet Telematics API](https://www.here.com/docs/category/fleet-telematics-api). Default is `undefined`.
     */
    getGeofencingService (opt_options ? : H.service.Options , opt_version ? : number ) : H.service.GeofencingService | H.service.extension.geofencing.Service ;
    /**
    ...
    /**
     * Create a new instance of {@link H.service.WaypointsSequenceService} to query the Waypoints Sequence API
     * at [HERE Waypoints Sequence API v8](https://www.here.com/docs/category/waypoints-sequence-api-v8)
     * @param options Configuration options for Waypoints Sequence service
     */
    getWaypointsSequenceService (options ? : H.service.Options ) : H.service.WaypointsSequenceService ;
    /**
...
declare namespace H.service {
  /**
   * This class encapsulates the [HERE Waypoints Sequence API v8](https://www.here.com/docs/category/waypoints-sequence-api-v8)
   * as a service stub.
   *
   * It's not allowed to call the constructor directly (an `IllegalOperationError` is thrown).
   * Instead an instance of this Service can be retrieved by calling the factory method
   * {@link H.service.Platform#getWaypointsSequenceService} on a platform instance.
   */
  class WaypointsSequenceService extends H.service.Service {
    /**
     * This class encapsulates the [HERE Waypoints Sequence API v8](https://www.here.com/docs/category/waypoints-sequence-api-v8)
     * as a service stub.
     *
    ...
    /**
     * This method sends a 'find sequence reqeuest' to the
     * [HERE Waypoints Sequence API v8](https://www.here.com/docs/category/waypoints-sequence-api-v8)
     * and calls the `onResult` callback function once the service response
     * becomes available (providing a {@link H.service.ServiceResult} object)
     * or the `onError` callback if a communication error or input format error occurs.
     *
     * Please refer to the
     * [HERE Waypoints Sequence API v8](https://www.here.com/docs/category/waypoints-sequence-api-v8) documentation
     * for information on available parameters and the response object structure.
     * @param params Contains service parameters to be sent with the request.
     * @param onResult A callback function to be called once the API provides a response to the request.
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    findSequence (params : H.service.ServiceParameters , onResult : (a : GlobalObject ) => any , onError : (a : Error ) => any ) : H.util.ICancelable ;
    /**
     * The property name to use when specifying options for this service
     * within the {@link H.service.Platform.Options#servicesConfig}.
     */
